...
const BookingFormDialog = ({ open, onOpenChange }: BookingFormDialogProps) => {
  ...
  const renderConfirmation = () => (
    <div className="flex flex-col items-center px-4 py-6 text-center space-y-5 overflow-y-auto max-h-[70vh]">
      {/* Success Icon with Animation */}
      <div className="relative flex-shrink-0">
        <div className="absolute inset-0 bg-primary/20 rounded-full blur-2xl animate-pulse" />
        <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-primary to-cyan-400 flex items-center justify-center shadow-[0_0_40px_rgba(56,189,248,0.4)]">
      ...
      {/* Details Card */}
      <div className="w-full max-w-md bg-primary/5 border border-primary/20 rounded-xl p-4 space-y-3 flex-shrink-0">
      ...
      {/* What's Next */}
      <div className="space-y-2 text-left w-full max-w-md flex-shrink-0">
        <h3 className="text-foreground font-semibold text-sm">Prochaines étapes :</h3>
      ...
      <Button
        ...
        className="w-full max-w-md h-11 mt-2 flex-shrink-0 bg-gradient-to-r from-primary to-cyan-500 text-primary-foreground hover:from-primary/90 hover:to-cyan-500/90 shadow-[0_0_20px_rgba(56,189,248,0.3)] hover:shadow-[0_0_30px_rgba(56,189,248,0.5)] transition-all duration-300"
      >
